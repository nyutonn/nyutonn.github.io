...
<img src="/assets/img/pika.png" width="400x400">
...
<!-- ##### プレイ動画
* クイズ動画（©1966 Pokémon. ©1995-1996 Nintendo/Creatures Inc./GAME FREAK inc. これは「Pokémon Game Sound Library」の利用規約に同意し作成されたコンテンツです。）
    <ul class="no-bullet"><li>
    <video width="600" controls>
    <source src="/assets/movie/tetris0_free_game.mp4" type="video/mp4">
    </video></li></ul> -->
